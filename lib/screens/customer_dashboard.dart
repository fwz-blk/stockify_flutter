    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
          gradient: RadialGradient(center: Alignment(-0.3, -0.3), radius: 1.0, colors: [Color(0x1A6C63FF), AppColors.bgPrimary]),
        ),
        child: SafeArea(
          child: Center(
            child: Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: AppColors.bgCard, borderRadius: BorderRadius.circular(24), border: Border.all(color: AppColors.borderLight)),
